    ...
    <aside class="layout-sidebar">
        <div class="sidebar-header">
            <router-link to="/" class="sidebar-brand">
                <svg class="sidebar-logo" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <mask id="sidebar-logo-mask" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8"
                        width="54" height="11">
                        <path
                ...
                <span class="sidebar-title">AutoCore</span>
            </router-link>
