    ...
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            >
                <svg viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <mask id="topbar-logo-mask" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="8"
                        width="54" height="11">
                        <path
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                <!--старт ЯЗЫК -->
                <button type="button" class="layout-topbar-action language-button" @click="toggleLanguage">
...
function handleLogoClick(event) {
    if (window.innerWidth > 991 && layoutState.staticMenuDesktopInactive) {
